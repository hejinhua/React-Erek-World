  ...
  render() {
    return (
      <div
        ...
        onMouseOver={this.handleArrowIconOver}
        onMouseOut={this.handleArrowIconOut}
      >
        ...
        <div className='media-container'>
          <div className='arrow icon-left' onClick={this.handlePre}>
            <img
              ...
              className='MediaArrowImage'
              alt='arrow-left'
            />
          </div>
          {ImageArray.map((item, index) => {
            return (
              <div className='media-slide-image fade' key={index}>
          ...
          {ImageArray.map((item, index) => {
            return (
              <span
                ...
                className='dot'
                onClick={() => {
                  this.handleCurrent(this, index + 1)
                }}
              />
            )
          })}
